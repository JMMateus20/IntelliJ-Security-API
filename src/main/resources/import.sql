...
INSERT INTO operations (name, path, http_method, permit_all, module_id) VALUES ('AUTHENTICATE','/authenticate', 'POST', true, 4);
...
INSERT INTO operations (name, path, http_method, permit_all, module_id) VALUES ('LOGOUT','/logout','POST', true, 4);

-- CREACIÓN DE ROLES
INSERT INTO roles (nombre) VALUES ('CUSTOMER');
INSERT INTO roles (nombre) VALUES ('ASSISTANT_ADMINISTRATOR');
INSERT INTO roles (nombre) VALUES ('ADMINISTRATOR');
